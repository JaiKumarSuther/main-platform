    ...
    <div class="checkout-container">
      <div class="left-section">
        ...
        <div class="payment-form">
          ...
          <label class="payment-option">
            ...
            <img src="@/assets/images/jazzcash-icon-checkout.svg" alt="JazzCash" />
          </label>
          ...
          <label class="payment-option">
            ...
            <img
              src="@/assets/images/easypaisa-icon-checkout.svg"
              alt="Easypaisa"
            />
          </label>
          ...
          <div class="card-section">
            <label class="payment-option card-label">
              ...
              <div class="card-logos">
                <img
                  src="@/assets/images/mastercard-svgrepo-com-1.svg"
                  alt="MasterCard"
                />
                <img src="@/assets/images/visa-svgrepo-com.svg" alt="Visa" />
                <img
      ...
      <div class="right-section">
        ...
        <div class="booking-card">
          <div class="image-box">
            <img src="@/assets/images/hunza-tour.png" alt="" />
            <div>
          ...
          <div class="details">
            <p class="duration">
              <img src="@/assets/images/duration-icon.svg" alt="" /> Duration
            </p>
            <span>14 days</span>
          </div>
          <div class="details">
          ...
          <div class="details">
            <p class="people">
              <img
                src="@/assets/images/people-icon-checkout-page.svg"
                alt=""
              />People
            </p>
          ...
          <p class="cancellation">
            <img src="@/assets/images/free-cancellation-icon.svg" alt="" /> Cancel
            for free until
