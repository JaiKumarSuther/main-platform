  ...
  <header>
    ...
    <div class="desktop-header">
      <div class="header-left">
        <div class="logo">
          <img
            src="@/assets/images/ninja-logo.svg"
      ...
      <div class="header-right">
        ...
        <div class="header-icons">
          <div class="menu">
            <img src="@/assets/images/currency-icon.svg" alt="Currency" /><span
              >US Dollar</span
            >
          </div>
          <div class="menu">
            <img src="@/assets/images/support-icon.svg" alt="Support" /><span
              >Support</span
            >
          </div>
          <img
    ...
    <div class="mobile-header">
      <div class="mobile-header-container">
        <div class="logo-section">
          <img
            src="@/assets/images/travelninja.png"
            alt="Travel Ninja Logo"
            class="logo-icon"
          />
        </div>
      ...
      <div class="mobile-menu" v-show="showMobileMenu">
        ...
        <div class="menu-content">
          <section>
            <h3>Profile</h3>
            <p>
              <img src="@/assets/images/profile-icon.svg" alt="Profile" /> Log
              in or sign up
            </p>
            <p>
              <img
            ...
            <p>
              <img
                src="@/assets/images/manage-bookings-icon.svg"
                alt="Bookings"
              />
              Manage bookings
            </p>
          ...
          <section>
            ...
            <p>
              <img
                src="@/assets/images/discover-icon-in-mobile-menu.svg"
                alt="Discover"
              />
            ...
            <p>
              <img
                src="@/assets/images/places-icon-in-mobile-menu.svg"
                alt="Places"
              />
              Places
              <img
          ...
          <section>
            ...
            <p>
              <img src="@/assets/images/currency-icon.svg" alt="Currency" />
